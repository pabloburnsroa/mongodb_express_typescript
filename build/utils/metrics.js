...
exports.databaseRsponseTimeHistogram = exports.restResponseTimeHistogram = void 0;
...
exports.databaseRsponseTimeHistogram = new prom_client_1.default.Histogram({
...
function metricsServer() {
    ...
    app.listen(9100, () => {
        logger_1.default.info(`Metrics server is running on http://localhost:9100`);
    });
}
